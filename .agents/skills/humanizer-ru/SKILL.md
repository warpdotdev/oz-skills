---
name: humanizer-ru
description: Remove AI-generation markers from Russian text and make it read like a human wrote it, using a catalog of 64 patterns, 21 hard bans and an optional deterministic scanner. Use when the user asks to humanize, rewrite, or audit Russian text that sounds machine-generated (очеловечить, убрать следы нейросети, звучит как робот); Russian only, for English use the humanizer skill.
license: MIT
metadata:
  version: "3.21.0"
  source: https://github.com/ilyautov/humanizer-ru
---
